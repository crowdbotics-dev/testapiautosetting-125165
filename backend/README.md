...
## Project Structure
    ...
    ├── testapiautosetting_125165  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125165`
...
2. Clone this repo and `cd testapiautosetting_125165`
